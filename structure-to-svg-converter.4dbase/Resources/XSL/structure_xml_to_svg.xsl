...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <xsl:element name="svg:svg">
      ...
      <xsl:attribute name="xmlns:xlink">
      ...
      nKn9Z/NAgaB68CX/kSPTk1H9Oh0UAdG0MCSfzfYnRPH1lkCw8AFIAr0+MUdYBso+h/JPcz9HgCnVQzBBwDfFwAAAABJRU5ErkJggg==" y="0"/>
      ...
      bLXbPwvgGjAKZPqe6PNH6Z+yHxpQA/0Q2BWAC1wGrIEhBkjEQP2cBCAC3p43zIt/4oKKQeiBPP53AEDEEDmlb4ziAAAAAElFTkSuQmCC" y="0"/>
      ...
      YrcJ3F3M7wEAWx7lE1IEvNoAAAAASUVORK5CYII=" y="0"/>
      ...
      pSZ/BgADtbuJ3KG4mgAAAABJRU5ErkJggg==" y="0"/>
      ...
      gnHEXRH2FjiVjUrRxEkXAlb8trN7uNDODGoTej/U3fU5knizwCW0dLNg9pzEwAAAABJRU5ErkJggg==" y="0"/>
      ...
      ZkCCvCkTab8dADUgZp04fi0cf87SGcd9mO/BwAyXOkbHWbB4wAAAABJRU5ErkJggg==" y="0"/>
      ...
      zgV7YM0TesGJLifaR6JjvKNAm7F5hrgDV5hsLaF/wEqGUA2zkV32wICjsZrymdOehUf8RkbW/3YzTe/3WQj+jMALMPB51DgWLIAAAAASUVORK5CYII=" y="0"/>
      ...
      LCUet3CPlrQh560X06ZoBkgxuGU0kGSpt1MfefQmma0nYo3IPj/n+nvABOjooQGZOMzAAAAAElFTkSuQmCC" y="0"/>
      ...
      njzYYwVy9rRWYbJm5HMb7dTDrKsCcjykNaa5OrZAyQNRWktl07tI8+LGZ2UZNlcQF5wuf8+/yMPqAPLgdZ/uPsBjDrnfv4aAGJgOzQ0Reu/AAAAAElFTkSuQmCC" y="
      0"/>
      ...
      e1e4TrQAjyAfkD/cSUBY9cru8OyAQtwgDB6LKXknwEAb1wzL9NzB2EAAAAASUVORK5CYII=" y="0"/>
    </svg:defs>
  ...
  <xsl:variable name="gradient_start_red">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="./table_extra/editor_table_info/color/@red * $table_start_brightness" />
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  ...
  <xsl:variable name="gradient_start_green">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="number(./table_extra/editor_table_info/color/@green) * $table_start_brightness" />
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  ...
  <xsl:variable name="gradient_start_blue">
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:value-of select="number(./table_extra/editor_table_info/color/@blue) * $table_start_brightness" />
      </xsl:otherwise>
    </xsl:choose>
  </xsl:variable>
  ...
  <xsl:variable name="source_red">
    <xsl:choose>
      <xsl:when test="string(number(key( 'table_by_uuid', $source_table_id )/table_extra/editor_table_info/color/@red))='NaN'">0</xsl:when>
      <xsl:otherwise>
  ...
  <xsl:variable name="source_green">
    <xsl:choose>
      <xsl:when test="string(number(key( 'table_by_uuid', $source_table_id )/table_extra/editor_table_info/color/@green))='NaN'">0</xsl:when>
      <xsl:otherwise>
  ...
  <xsl:variable name="source_blue">
    <xsl:choose>
      <xsl:when test="string(number(key( 'table_by_uuid', $source_table_id )/table_extra/editor_table_info/color/@blue))='NaN'">0</xsl:when>
      <xsl:otherwise>
  ...
  <xsl:variable name="destination_red">
    <xsl:choose>
      <xsl:when test="string(number(key( 'table_by_uuid', $destination_table_id )/table_extra/editor_table_info/color/@red))='NaN'">0</xsl:when>
      <xsl:otherwise>
  ...
  <xsl:variable name="destination_green">
    <xsl:choose>
      <xsl:when test="string(number(key( 'table_by_uuid', $destination_table_id )/table_extra/editor_table_info/color/@green))='NaN'">0</xsl:when>
      <xsl:otherwise>
  ...
  <xsl:variable name="destination_blue">
    <xsl:choose>
      <xsl:when test="string(number(key( 'table_by_uuid', $destination_table_id )/table_extra/editor_table_info/color/@blue))='NaN'">0</xsl:when>
      <xsl:otherwise>
  ...
  <xsl:value-of select="number(./table_extra/editor_table_info/coordinates/@width) + number(./table_extra/editor_table_info/coordinates/@left) - 18" />
  </xsl:variable>
  ...
  <xsl:value-of select="number(./table_extra/editor_table_info/coordinates/@left)" />
  </xsl:attribute>
  <xsl:attribute name="y">
  <xsl:value-of select="number(./table_extra/editor_table_info/coordinates/@top)" />
  </xsl:attribute>
  <xsl:attribute name="height">
